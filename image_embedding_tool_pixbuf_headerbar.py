...
#
# The image is displayed as the logo in the About dialog, the Favicon in the 
# system task bar, as a logo in the HeaderBar, and in the hbox of a frame.
#
...
# Labelling...
VERSION = "2021-05-14"
TITLE = "Image Embedding Tool using GdkPixuf with Headerbar loaded by Builder"
SUBTITLE = "2021-05-14"
...
AUTHOR = "Ian Stewart"
COMMENT = "Demostrating Embedded Images and HeadBar/Gtk.Builder"
WEBSITE = "https://github.com/irsbugs/image-embedding-tool"
...
class Main_Window(Gtk.Window):
    ...
    def setup_header_bar(self):
        # Setup of Headerbar is done with XML and Builder.
        ...
        # Place the image into the Header Bar
    ...
    def cb_button_header_1(self, widget):
        'Display the about dialog'
        self.about.show()
        
        
    def cb_about_hide(self, widget, huh):
        'Hide the About Dialog'
        self.about.hide()        


    def cb_button_1(self, widget):
        'Select the Image file to be used'
    ...
    def open_file_chooser(self):
        'Select an Image file to convert to Base64 data'
...
This program contains three images. Start the program with the command line
parameter 1 or 2, to see examples of a GUI with other images. E.g.

$ python image_embedding_tool_pixbuf_headerbar.py 1
$ python image_embedding_tool_pixbuf_headerbar.py 2

""".format(VERSION)


# The HeaderBar is added using this XML data. It contains a Gtk.Image with an
# id of "image_1". Initially There is no image until the following code provides
# the image:
#   image = builder.get_object("image_1")
#   image.set_from_pixbuf(self.image)
#
# The about_dialog's logo is commented out:
#     <!--property name="logo"></property-->
# The logo is added later with:
#   self.about = builder.get_object("about_dialog")
#   self.about.set_logo(self.image)
ui_info = """
...
<interface>
  ...
  <object class="GtkHeaderBar" id="header_1">
    ...
    <property name="title" translatable="yes">Header Bar Example</property>
    <property name="subtitle" translatable="yes">Using Gtk.Builder</property>
    ...
    <child>
      <object class="GtkButton">
        ...
        <signal name="clicked" handler="cb_button_header_1" swapped="no"/>             
      </object>
      <packing>
